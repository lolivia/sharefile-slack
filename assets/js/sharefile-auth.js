            ...
            */
            secureLogin: function (options) {
                ...
                var
                    ...
                    replacementUri,
                    // redirect url
                    redirectUri = options.redirectUri || "https://slashsf5.azurewebsites.net/",
                    // client id key
                    clientId = options.clientId || "XQ7ua8NG0X38d0TxOsUpdUEBGHK4TCD2",
                ...
                location.href = replacementUri;
                // window.open(replacementUri, "_blank", "location=no, width=900, height=700, menubar=no, resizable=yes, scrollbars=yes, status=no, titlebar=no, toolbar=no");
            }
        };
